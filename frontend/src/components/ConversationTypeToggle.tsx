      ...
      >
        <div className="flex items-center justify-center space-x-2">
          <div className="relative">
            ...
            {groupsUnreadCount > 0 && (
              <span className="absolute -top-1.5 -right-1.5 bg-amber-600 text-white text-xs rounded-full min-w-[16px] h-4 flex items-center justify-center px-1 font-semibold shadow-sm">
