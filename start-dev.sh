...
echo ""
echo "Alternative backend commands:"
echo "   • ./gradlew bootRunDev  (development profile)"
echo "   • ./gradlew build       (full build with tests)"
echo "   • ./gradlew devBuild    (quick build, no frontend)"
echo ""
